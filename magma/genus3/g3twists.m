 ...
 *
 *  Copyright 2012-2020, R. Basson, R. Lercier, C. Ritzenthaler & J. Sijsling
 */
...
function G3ModelsInCharFF_G8_5(JI : geometric := false)
    ...
    */
	...
	ret, ML := IsGL2EquivalentExtended(Parent(x)!k_cov[1], k2, 4);
        ML := [* Eltseq(c) : c in ML *];
...
//    sigma := FrobeniusMap(K12, FF);
    ...
    ret, MLc := IsGL2EquivalentExtended(f, fc, 8);
